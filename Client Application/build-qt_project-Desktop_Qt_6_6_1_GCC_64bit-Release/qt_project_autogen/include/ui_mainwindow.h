...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon(QIcon::fromTheme(QString::fromUtf8("input-keyboard")));
        ...
        label_2->setGeometry(QRect(70, 170, 531, 171));
        QFont font;
        ...
        continue_button->setGeometry(QRect(240, 310, 161, 91));
        QFont font1;
        ...
        pushButton->setGeometry(QRect(210, 0, 221, 201));
        QIcon icon1(QIcon::fromTheme(QString::fromUtf8("mail-replied")));
        pushButton->setIcon(icon1);
        pushButton->setIconSize(QSize(191, 204));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_2->setText(QApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:22pt;\">Welcome to Messenger. </span></p><p><span style=\" font-size:22pt;\">Please login or create an account. </span></p></body></html>", nullptr));
        continue_button->setText(QApplication::translate("MainWindow", "Continue", nullptr));
